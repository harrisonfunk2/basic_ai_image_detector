...
1. Loads the REAL image from `data/real/<name>`
2. Loads the AI image from `data/ai/<name>`
3. Run both through ResNet50 
...
> Brief interpretation: The ROC curve/AUC summarizes ranking quality across all thresholds.
...
- This is focused on one photo domain, only scenic ocean images, so it may not generalize to other image types
...
- Collect more real photos and AI recreations to improve stability and sample size 
- Expand beyond scenic ocean images
